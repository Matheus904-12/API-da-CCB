...
const sCapitulo = document.querySelector('#m-funcao'); // Alterado para sCapitulo
const sVersiculo = document.querySelector('#m-funcao'); // Alterado para sVersiculo
const sData = document.querySelector('#m-date'); // Alterado para sData
