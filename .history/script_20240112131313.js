...
function openModal(edit = false, index = 0) {
    ...
    if (edit) {
        ...
        sVersiculo.value = funcionarios[index].versiculo;
...
function saveFuncionario() {
    ...
    if (id !== undefined) {
        funcionarios[id].auxiliar = sAuxiliar.value;
        funcionarios[id].nome = sNome.value;
        funcionarios[id].funcao = sFuncao.value;
        funcionarios[id].capitulo = sCapitulo.value;
        funcionarios[id].versiculo = sVersiculo.value;
        funcionarios[id].data = sData.value;
    } else {
        funcionarios.push({
